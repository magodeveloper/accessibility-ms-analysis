...
/// </summary>
public class MemoryHealthCheck(ILogger<MemoryHealthCheck> logger, long threshold = 1024L * 1024L * 1024L) : IHealthCheck
{
    private readonly ILogger<MemoryHealthCheck> _logger = logger;
    private readonly long _threshold = threshold;
