    ...
    ILogger<AnalysisService> logger) : IAnalysisService
{
    ...
    public async Task DeleteAllAsync()
    {
        ...
        {
            _ = await _db.Database.ExecuteSqlRawAsync("ALTER TABLE ANALYSIS AUTO_INCREMENT = 1");
        }
    }

    private static AnalysisDto ToReadDto(AnalysisEntity a) => new(
        a.Id,
        a.UserId,
        a.DateAnalysis,
