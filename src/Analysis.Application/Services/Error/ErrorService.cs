...
public class ErrorService(AnalysisDbContext db) : IErrorService
{
    ...
    public async Task DeleteAllAsync()
    {
        ...
        {
            _ = await _db.Database.ExecuteSqlRawAsync("ALTER TABLE ERRORS AUTO_INCREMENT = 1");
        }
    }

    private static ErrorDto ToReadDto(ErrorEntity e) => new(
        e.Id,
        e.ResultId,
        e.WcagCriterionId,
        e.ErrorCode,
